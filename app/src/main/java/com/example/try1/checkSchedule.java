...
public class checkSchedule extends AppCompatActivity {
    ...
    Button dateButton1, timeButton1 , checkSchedule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkSchedule = findViewById(R.id.btn_checkSchedule);

        checkSchedule.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(checkSchedule.this,checkSchedule1.class);
