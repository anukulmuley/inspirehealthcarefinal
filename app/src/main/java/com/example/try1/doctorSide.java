...
public class doctorSide extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(doctorSide.this,loginAs.class);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.d1:
                i=new Intent (doctorSide.this,checkSchedule.class);
                startActivity(i);
                break;
            case R.id.d2:
                i=new Intent (doctorSide.this,keepNotes.class);
                startActivity(i);
                break;
            case R.id.d3:
                i=new Intent (doctorSide.this,statusReport.class);
                startActivity(i);
                break;
            case R.id.d4:
                i=new Intent (doctorSide.this,liveChat.class);
                startActivity(i);
                break;
            case R.id.d5:
